...
SoapClient.prototype.invoke = function( method, params ){
    var self = this;
    var req = new srequest.SoapRequest(method, params, this.wsdl, this.namespace, this.location, this.username, this.password);
    req.end();
    return req;
}
...
SoapClient.prototype.lookupComplexType = function( typeName, doc, typeNamespace ){
    var paramSequenceLookup = "//xmlns:*[@name='"+typeName+"']//xmlns:sequence/xmlns:element";
