...
function SoapRequest(method, params, url, namespace, soapAddress, username, password){
...
SoapRequest.prototype.end = function(){
    ...
    if( typeof(this.username) != "undefined" && typeof(this.password) != "undefined" ){
        endpoint = info.protocol + "//" + this.username + ":" + this.password + "@" + info.hostname + info.pathname;
    }
    else{
        endpoint = info.protocol + "//" + info.hostname + info.pathname;
    }
