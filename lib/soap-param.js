...
function SoapParam( name, value, type, definition ){
    ...
    this.serialize_map = {
        ...
        "boolean": this.returnBare,
        "number": this.returnBare,
        "int": this.returnBare,
        "decimal": this.returnBare,
...
SoapParam.prototype.serialize = function(value){
    try{
        ...
        console.log( "Do not know how to serialize " + value );
        return false;
    }
}
...
SoapParam.prototype.returnBare = function( value ){
    return value;
}
